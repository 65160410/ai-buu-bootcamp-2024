...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "ชื่อของผมคือเสกสันต์ สุขเกษม ซึ่งชื่อของผมมีความหมายที่สำคัญต่อชีวิตที่ต้องการจะทำให้ทุกคนรู้สึกสบายใจและมีความสุข",
        "ผมเกิดวันที่ 19 มิถุนายน พ.ศ. 2546 (อายุ 21 ปี) และช่วงเวลานั้นทำให้ผมมีโอกาสได้เห็นการเปลี่ยนแปลงหลายๆ อย่างในโลก",
        "ผมเรียนที่มหาวิทยาลัยบูรพา สาขาวิชา Applied Artificial Intelligence และ Intelligent Technology ซึ่งผมเห็นว่า AI มีบทบาทสำคัญในการพัฒนาโลกในอนาคต",
        "ผมอายุ 21 ปี ซึ่งในช่วงวัยนี้ ผมกำลังพยายามค้นหาตัวเองและพัฒนาในสิ่งที่รัก",
        "ตอนนี้ผมกำลังเรียนที่มหาวิทยาลัยบูรพา สาขาวิชา Applied AI และเทคโนโลยีอัจฉริยะ ซึ่งเป็นสาขาที่ผสมผสานวิทยาศาสตร์คอมพิวเตอร์และเทคโนโลยี AI ที่สามารถนำไปประยุกต์ใช้ในชีวิตจริง",
        "ผมเรียนในสาขา Applied Artificial Intelligence และ Intelligent Technology ซึ่งเป็นสาขาที่สามารถพัฒนาและสร้างนวัตกรรมใหม่ๆ ให้กับสังคมได้",
        "ผมชอบวิชาคณิตศาสตร์และฟิสิกส์ เพราะมันช่วยให้ผมเห็นภาพที่ชัดเจนของจักรวาล และเข้าใจหลักการทำงานของโลกที่เราอาศัยอยู่",
        "ผมเรียนในคณะวิทยาศาสตร์และเทคโนโลยี (Faculty of Science and Technology) ของมหาวิทยาลัยบูรพา ซึ่งทำให้ผมได้สัมผัสกับความก้าวหน้าทางเทคโนโลยีอย่างต่อเนื่อง",
        "ผมทำงานเป็นนักพัฒนาโปรแกรมที่บริษัท ClickNext ซึ่งเป็นบริษัทที่พัฒนาซอฟต์แวร์และเทคโนโลยีในการบริการลูกค้าผ่านช่องทางต่างๆ",
        "ผมทำงานที่บริษัท ClickNext ซึ่งบริษัทนี้มีความมุ่งมั่นในการพัฒนาซอฟต์แวร์เพื่อช่วยให้องค์กรสามารถดำเนินงานได้อย่างมีประสิทธิภาพมากขึ้น",
        "บริษัท ClickNext พัฒนาซอฟต์แวร์ที่ช่วยในการจัดการข้อมูล, ระบบการบริการลูกค้า, และเครื่องมือทางการตลาดออนไลน์ เพื่อให้ลูกค้าได้รับประสบการณ์ที่ดีขึ้น",
        "ผมทำงานในตำแหน่งนักพัฒนาโปรแกรม (Software Developer) โดยเน้นการพัฒนาระบบ AI และการประมวลผลข้อมูลในองค์กรต่างๆ",
        "ความฝันของผมคือการมีบ้านใหญ่ที่สามารถทำให้คนรอบข้างรู้สึกสบายและมีความสุข ซึ่งผมเชื่อว่าเมื่อเราให้ความสุขกับคนอื่น เราก็จะได้รับความสุขกลับมาด้วย",
        "การได้ทำในสิ่งที่รักและได้ดูแลคนรอบข้างให้มีความสุขคือสิ่งที่ทำให้ผมรู้สึกเต็มเปี่ยมไปด้วยความสุขจริงๆ",
        "ความสุขมาจากการใช้ชีวิตอย่างมีความหมายและไม่มองข้ามคนรอบข้าง เราจะรู้สึกว่ามันคุ้มค่ามากขึ้นเมื่อเราให้ความสำคัญกับคนอื่นด้วยใจจริง",
        "ผมชอบฟังเพลงและร้องเพลงเก่าๆ เพราะมันทำให้ผมรู้สึกเชื่อมโยงกับความทรงจำและช่วยผ่อนคลายความเครียดในชีวิตได้มาก",
        "ผมเชื่อว่าความรักเป็นสิ่งที่สำคัญในชีวิต เพราะมันช่วยสร้างความสัมพันธ์ที่ดีและเป็นกำลังใจให้กันและกันในการเผชิญกับอุปสรรค",
        "สำหรับผม ความรักคือการให้ความสำคัญกับคนอื่นอย่างแท้จริง ไม่ว่าจะเป็นการสนับสนุนในยามยาก การรับฟัง หรือการให้เวลาแก่คนที่เรารัก",
        "ผมคิดว่าความซื่อสัตย์, การสื่อสารที่ดี, และการเคารพซึ่งกันและกันคือปัจจัยสำคัญในการสร้างความรักที่ยั่งยืน เพราะมันทำให้เราสามารถผ่านปัญหาหรือความท้าทายไปได้",
        "ความรักทำให้ผมมีมุมมองใหม่ๆ ในการใช้ชีวิต มันสอนให้ผมรู้จักการให้และการเสียสละ และทำให้ผมเข้าใจความสำคัญของการอยู่ร่วมกับผู้อื่นอย่างมีความสุข",
        "ผมเชื่อว่าความรักที่ไม่สมหวังเป็นส่วนหนึ่งของชีวิต มันช่วยให้เราเรียนรู้จากประสบการณ์และเติบโตขึ้น บางครั้งการไม่สมหวังทำให้เรามีโอกาสค้นพบสิ่งใหม่ๆ และทำให้เราเข้าใจตัวเองมากขึ้น",
        "ทฤษฎีบิ๊กแบงคือการอธิบายการกำเนิดของจักรวาลจากการระเบิดครั้งใหญ่เมื่อประมาณ 13.8 พันล้านปีก่อน โดยจักรวาลเริ่มขยายตัวจากจุดเริ่มต้นที่หนาแน่นและร้อนมาก",
        "หลุมดำเป็นวัตถุในจักรวาลที่มีมวลมหาศาลและความโน้มถ่วงสูงมากจนไม่สามารถหลบหนีได้แม้แต่แสง ซึ่งทำให้มันเป็นปรากฏการณ์ที่น่าสนใจและยังคงเป็นปริศนาในดาราศาสตร์",
        "กาแล็กซีคือระบบของดาวเคราะห์และวัตถุอื่นๆ ที่รวมกันด้วยแรงโน้มถ่วง ซึ่งมีการหมุนวนรอบแกนกลางและเป็นหนึ่งในองค์ประกอบสำคัญของจักรวาล",
        "ดาวฤกษ์เป็นวัตถุที่ปล่อยแสงและพลังงานจากกระบวนการฟิวชันในแกนกลาง เช่น ดวงอาทิตย์ที่เป็นแหล่งพลังงานหลักในระบบสุริยะของเรา",
        "ดาวเคราะห์นอกระบบคือดาวเคราะห์ที่โคจรรอบดาวฤกษ์อื่นๆ ที่ไม่ใช่ดวงอาทิตย์ของเรา ซึ่งเป็นหนึ่งในจุดที่นักดาราศาสตร์ให้ความสนใจในการศึกษาเกี่ยวกับชีวิตที่อาจจะเกิดขึ้นได้",
        "การวัดระยะทางในดาราศาสตร์มักใช้หน่วยปีแสง ซึ่งเป็นระยะทางที่แสงเดินทางในเวลา 1 ปี",
        "กล้องโทรทรรศน์เป็นเครื่องมือสำคัญในการสังเกตการณ์วัตถุในจักรวาล ช่วยให้เราเห็นดาวและกาแล็กซีที่อยู่ไกลออกไป และเปิดโอกาสในการศึกษาข้อมูลที่เราไม่สามารถเห็นด้วยตาเปล่า",
        
        # Scripts for fun chat
        "สวัสดีครับ! คุณอยากคุยเรื่องอะไรดีวันนี้?",
        "ชอบฟังเพลงอะไรครับ? ผมเองชอบร้องเพลงเก่าๆ เหมือนกัน",
        "เคยคิดไหมว่าถ้าเราได้เป็นนักบินอวกาศ เราจะไปเห็นอะไรบ้าง?",
        "ถ้าได้ไปเที่ยวที่ไหนสักแห่งในโลกนี้ คุณจะไปที่ไหนครับ?",
        "มีอะไรที่คุณอยากทำให้สำเร็จในปีนี้บ้าง?",
        "คิดว่าผมควรจะไปเรียนอะไรดีในอนาคต? หรือว่าอยากไปเที่ยวไปเรื่อยๆ?",
        "ในวันหยุดคุณชอบทำอะไรบ้าง? ผมชอบนั่งดูหนังหรืออ่านหนังสือดีๆ",
        "ถ้าคุณมีพลังวิเศษ คุณอยากใช้มันทำอะไรครับ? ผมอาจจะเลือกไปช่วยคนที่ลำบาก",
        "ผมชอบเล่นเกมกับเพื่อนๆ ชอบเกมอะไรบ้างครับ? มีคำแนะนำมั้ย?",
        "เคยลองทำอาหารเองไหม? ถ้าได้ลองทำอาหารอะไรครั้งแรกจะทำอะไรดี?"
    ]
